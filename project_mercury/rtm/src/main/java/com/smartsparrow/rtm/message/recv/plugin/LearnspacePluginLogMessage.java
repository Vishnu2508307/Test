...
public class LearnspacePluginLogMessage extends ReceivedMessage implements PluginLogMessage {
    ...
    public boolean equals(final Object o) {
        ...
        LearnspacePluginLogMessage that = (LearnspacePluginLogMessage) o;
        return Objects.equals(pluginId, that.pluginId) && Objects.equals(version,
                ...
                elementId,
                that.elementId) && elementType == that.elementType && Objects.equals(deploymentId,
                                                                                     that.deploymentId) && Objects.equals(
                cohortId,
                that.cohortId) && Objects.equals(eventId, that.eventId) && Objects.equals(transactionId,
                                                                                          that.transactionId) && Objects.equals(
                transactionName,
    ...
    public String toString() {
        return "LearnspacePluginLogMessage{" +
                "pluginId=" + pluginId +
                ", version='" + version + '\'' +
                ", level=" + level +
                ", message='" + message + '\'' +
