...
/**
 * This RTM consumable describes an activity feedback deleted event
 */
public class FeedbackDeletedRTMConsumable extends AbstractRTMConsumable<ActivityBroadcastMessage> {

    private static final long serialVersionUID = -7112354103762760372L;

    public FeedbackDeletedRTMConsumable(RTMClientContext rtmClientContext, ActivityBroadcastMessage content) {
