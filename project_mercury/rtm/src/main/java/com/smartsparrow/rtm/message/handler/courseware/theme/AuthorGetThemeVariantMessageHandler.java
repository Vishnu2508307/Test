...
public class AuthorGetThemeVariantMessageHandler implements MessageHandler<GetThemeVariantMessage> {

    private static final MercuryLogger log = MercuryLoggerFactory.getLogger(AuthorGetThemeVariantMessageHandler.class);

    public static final String AUTHOR_THEME_VARIANT_GET = "author.theme.variant.get";
    public static final String AUTHOR_THEME_VARIANT_GET_OK = "author.theme.variant.get.ok";
    public static final String AUTHOR_THEME_VARIANT_GET_ERROR = "author.theme.variant.get.error";

    private final ThemeService themeService;

    @Inject
    public AuthorGetThemeVariantMessageHandler(ThemeService themeService) {
    ...
    @Trace(dispatcher = true, nameTransaction = false, metricName = AUTHOR_THEME_VARIANT_GET)
    @Override
                ...
                .subscribe(themeVariant -> {
                           ...
                           ex -> {
                               ...
                               Responses.errorReactive(session,
                                                       message.getId(),
                                                       AUTHOR_THEME_VARIANT_GET_ERROR,
