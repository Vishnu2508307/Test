...
public class AllowCohortReviewerOrHigher implements AuthorizationPredicate<CohortMessage> {

    private static final Logger log = LoggerFactory.getLogger(AllowCohortReviewerOrHigher.class);

    private final CohortPermissionService cohortPermissionService;

    @Inject
    public AllowCohortReviewerOrHigher(CohortPermissionService cohortPermissionService) {
