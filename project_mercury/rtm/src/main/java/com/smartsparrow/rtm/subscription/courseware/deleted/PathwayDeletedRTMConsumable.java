...
/**
 * This RTM consumable describes an pathway deleted event
 */
public class PathwayDeletedRTMConsumable extends AbstractRTMConsumable<ActivityBroadcastMessage> {

    private static final long serialVersionUID = 4826790784520861814L;

    public PathwayDeletedRTMConsumable(RTMClientContext rtmClientContext, ActivityBroadcastMessage content) {
