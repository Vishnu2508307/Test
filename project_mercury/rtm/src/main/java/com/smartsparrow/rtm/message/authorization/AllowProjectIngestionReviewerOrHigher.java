...
public class AllowProjectIngestionReviewerOrHigher extends ProjectIngestionAuthorizer
        implements AuthorizationPredicate<IngestionMessage> {

    @Inject
    public AllowProjectIngestionReviewerOrHigher(final ProjectIngestionAuthorizerService projectIngestionAuthorizerService) {
