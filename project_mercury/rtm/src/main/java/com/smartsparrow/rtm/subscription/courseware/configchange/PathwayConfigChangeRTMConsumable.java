...
/**
 * This RTM consumable describes an pathway config change event
 */
public class PathwayConfigChangeRTMConsumable extends AbstractRTMConsumable<ConfigChangeBroadcastMessage> {

    private static final long serialVersionUID = 1881185529201666500L;

    public PathwayConfigChangeRTMConsumable(RTMClientContext rtmClientContext, ConfigChangeBroadcastMessage content) {
