...
public class AllowCoursewareRootElementExportAuthorizer implements AuthorizationPredicate<CreateCoursewareRootElementExportMessage> {
    private static final MercuryLogger log = MercuryLoggerFactory.getLogger(AllowCoursewareRootElementExportAuthorizer.class);

    private final CoursewareElementAuthorizerService coursewareElementAuthorizerService;

    @Inject
    public AllowCoursewareRootElementExportAuthorizer(final CoursewareElementAuthorizerService coursewareElementAuthorizerService) {
     ...
     */
    @Override
    public boolean test(AuthenticationContext authenticationContext, CreateCoursewareRootElementExportMessage message) {
