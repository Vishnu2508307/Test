...
/**
 * This RTM consumable describes an activity interactive deleted event
 */
public class InteractiveDeletedRTMConsumable extends AbstractRTMConsumable<InteractiveCreatedBroadcastMessage> {

    private static final long serialVersionUID = -4333663572970129209L;

    public InteractiveDeletedRTMConsumable(RTMClientContext rtmClientContext, InteractiveCreatedBroadcastMessage content) {
