...
/**
 * This RTM consumable describes an interactive created event
 */
public class InteractiveCreatedRTMConsumable extends AbstractRTMConsumable<InteractiveCreatedBroadcastMessage> {

    private static final long serialVersionUID = -5436774699311374492L;

    public InteractiveCreatedRTMConsumable(RTMClientContext rtmClientContext, InteractiveCreatedBroadcastMessage content) {
