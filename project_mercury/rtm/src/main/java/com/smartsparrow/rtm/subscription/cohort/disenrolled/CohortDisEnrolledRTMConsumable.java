...
/**
 * This RTM consumable describes a cohort dis enrolled event
 */
public class CohortDisEnrolledRTMConsumable extends AbstractRTMConsumable<CohortBroadcastMessage> {

    private static final long serialVersionUID = -1084967799691724826L;

    public CohortDisEnrolledRTMConsumable(RTMClientContext rtmClientContext, CohortBroadcastMessage content) {
