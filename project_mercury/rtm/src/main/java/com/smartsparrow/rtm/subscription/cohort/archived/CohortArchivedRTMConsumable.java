...
/**
 * This RTM consumable describes a cohort archived event
 */
public class CohortArchivedRTMConsumable extends AbstractRTMConsumable<CohortBroadcastMessage> {

    private static final long serialVersionUID = -1094967799691724827L;

    public CohortArchivedRTMConsumable(RTMClientContext rtmClientContext, CohortBroadcastMessage content) {
