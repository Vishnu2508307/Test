...
class ScenarioCreatedRTMConsumerTest {

    @InjectMocks
    private ScenarioCreatedRTMConsumer createdRTMConsumer;
    ...
    @Mock
    private ScenarioCreatedBroadcastMessage message;
    ...
    void setUp() {
        ...
        when(scenarioCreatedRTMConsumable.getContent()).thenReturn(message);
        when(scenarioCreatedRTMConsumable.getBroadcastType()).thenReturn(broadcastType);
        when(scenarioCreatedRTMConsumable.getSubscriptionId()).thenReturn(subscriptionId);
    ...
    void accept_filterOutSameClientProducer() {
        when(scenarioCreatedRTMConsumable.getRTMClientContext()).thenReturn(rtmClientContext);

        createdRTMConsumer.accept(rtmClient, scenarioCreatedRTMConsumable);
    ...
    void accept_writesToWebSocket() {
        ...
        when(scenarioCreatedRTMConsumable.getRTMClientContext()).thenReturn(producer);
