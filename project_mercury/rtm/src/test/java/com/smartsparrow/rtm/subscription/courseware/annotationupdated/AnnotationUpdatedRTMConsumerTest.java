...
class AnnotationUpdatedRTMConsumerTest {

    @InjectMocks
    private AnnotationUpdatedRTMConsumer updatedRTMConsumer;
    ...
    void setUp() {
        ...
        when(annotationUpdatedRTMConsumable.getContent()).thenReturn(message);
        when(annotationUpdatedRTMConsumable.getBroadcastType()).thenReturn(broadcastType);
        when(annotationUpdatedRTMConsumable.getSubscriptionId()).thenReturn(subscriptionId);
    ...
    void accept_filterOutSameClientProducer() {
        when(annotationUpdatedRTMConsumable.getRTMClientContext()).thenReturn(rtmClientContext);

        updatedRTMConsumer.accept(rtmClient, annotationUpdatedRTMConsumable);
    ...
    void accept_writesToWebSocket() {
        ...
        when(annotationUpdatedRTMConsumable.getRTMClientContext()).thenReturn(producer);
        ...
        final String expected = "{" +
                ...
                "\"response\":{" +
                    ...
                    "\"rtmEvent\":\"ACTIVITY_ANNOTATION_UPDATED\"," +
