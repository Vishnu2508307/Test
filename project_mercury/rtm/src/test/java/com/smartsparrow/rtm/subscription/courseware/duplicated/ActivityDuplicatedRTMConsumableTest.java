...
class ActivityDuplicatedRTMConsumableTest {
    ...
    void create() {
        ...
        ActivityDuplicatedRTMConsumable consumable = new ActivityDuplicatedRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new ActivityDuplicatedRTMEvent().getName(), consumable.getRTMEvent().getName());
