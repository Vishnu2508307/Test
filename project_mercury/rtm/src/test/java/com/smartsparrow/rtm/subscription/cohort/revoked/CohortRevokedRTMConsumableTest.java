...
class CohortRevokedRTMConsumableTest {
    ...
    void cohort_revoked() {
        ...
        CohortRevokedRTMConsumable consumable = new CohortRevokedRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new CohortRevokedRTMEvent().getName(), consumable.getRTMEvent().getName());
