...
import static com.smartsparrow.rtm.message.handler.math.LearnerMathAssetGetMessageHandler.LEARNER_MATH_ASSET_GET_ERROR;
import static com.smartsparrow.rtm.message.handler.math.LearnerMathAssetGetMessageHandler.LEARNER_MATH_ASSET_GET_OK;
...
public class LearnerMathAssetGetMessageHandlerTest {

    @InjectMocks
    private LearnerMathAssetGetMessageHandler handler;
    ...
    void handle() throws IOException {
        ...
        MessageHandlerTestUtils.verifySentMessage(session, response -> {
            assertAll(() -> {
                assertEquals(LEARNER_MATH_ASSET_GET_OK, response.getType());
            });
        });
    }
    ...
    void handle_exception() throws IOException {
        ...
        MessageHandlerTestUtils.verifySentMessage(session,
                                                  "{\"type\":\"" + LEARNER_MATH_ASSET_GET_ERROR + "\",\"code\":422," +
                                                          "\"message\":\"error fetching learner Math asset\"}");
    }
}
