...
class CohortEnrolledRTMConsumerTest {

    @InjectMocks
    private CohortEnrolledRTMConsumer cohortEnrolledRTMConsumer;

    @Mock
    private RTMClient rtmClient;

    @Mock
    private CohortEnrolledRTMConsumable cohortEnrolledRTMConsumable;
    ...
    void setUp() {
        ...
        when(cohortEnrolledRTMConsumable.getContent()).thenReturn(message);
        when(cohortEnrolledRTMConsumable.getBroadcastType()).thenReturn(broadcastType);
        when(cohortEnrolledRTMConsumable.getSubscriptionId()).thenReturn(subscriptionId);
    ...
    void accept_filterOutSameClientProducer() {
        when(cohortEnrolledRTMConsumable.getRTMClientContext()).thenReturn(rtmClientContext);

        cohortEnrolledRTMConsumer.accept(rtmClient, cohortEnrolledRTMConsumable);
    ...
    void accept_writesToWebSocket() {
        ...
        when(cohortEnrolledRTMConsumable.getRTMClientContext()).thenReturn(producer);
