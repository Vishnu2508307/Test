...
import static com.smartsparrow.rtm.message.handler.courseware.GetCoursewareStructureMessageHandler.COURSEWARE_STRUCTURE_GET_ERROR;
import static com.smartsparrow.rtm.message.handler.courseware.GetCoursewareStructureMessageHandler.COURSEWARE_STRUCTURE_GET_OK;
...
public class GetCoursewareStructureMessageHandlerTest {

    @InjectMocks
    private GetCoursewareStructureMessageHandler handler;
    @Mock
    ...
    void handle() throws IOException {
        ...
        MessageHandlerTestUtils.verifySentMessage(session, response -> {
            assertAll(() -> {
                assertEquals(COURSEWARE_STRUCTURE_GET_OK, response.getType());
            });
        });
    }
    ...
    void handle_exception() throws IOException {
        ...
        MessageHandlerTestUtils.verifySentMessage(session, "{\"type\":\"" + COURSEWARE_STRUCTURE_GET_ERROR + "\",\"code\":422," +
                "\"message\":\"error fetching courseware element structure\"}");
    }
}
