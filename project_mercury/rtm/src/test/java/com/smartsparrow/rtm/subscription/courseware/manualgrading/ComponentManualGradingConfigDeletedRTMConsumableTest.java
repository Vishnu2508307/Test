...
class ComponentManualGradingConfigDeletedRTMConsumableTest {
    ...
    void create() {
        ...
        ComponentManualGradingConfigDeletedRTMConsumable consumable = new ComponentManualGradingConfigDeletedRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new ComponentManualGradingConfigDeletedRTMEvent().getName(), consumable.getRTMEvent().getName());
