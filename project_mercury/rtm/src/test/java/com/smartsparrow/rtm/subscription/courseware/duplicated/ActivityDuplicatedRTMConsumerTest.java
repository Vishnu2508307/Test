...
class ActivityDuplicatedRTMConsumerTest {

    @InjectMocks
    private ActivityDuplicatedRTMConsumer duplicatedRTMConsumer;
    ...
    void setUp() {
        ...
        when(activityDuplicatedRTMConsumable.getContent()).thenReturn(message);
        when(activityDuplicatedRTMConsumable.getBroadcastType()).thenReturn(broadcastType);
        when(activityDuplicatedRTMConsumable.getSubscriptionId()).thenReturn(subscriptionId);
    ...
    void accept_filterOutSameClientProducer() {
        when(activityDuplicatedRTMConsumable.getRTMClientContext()).thenReturn(rtmClientContext);

        duplicatedRTMConsumer.accept(rtmClient, activityDuplicatedRTMConsumable);
    ...
    void accept_writesToWebSocket() {
        ...
        when(activityDuplicatedRTMConsumable.getRTMClientContext()).thenReturn(producer);
