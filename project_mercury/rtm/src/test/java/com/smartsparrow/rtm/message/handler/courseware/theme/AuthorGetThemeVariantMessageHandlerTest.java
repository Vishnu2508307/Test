...
import static com.smartsparrow.rtm.message.handler.courseware.theme.AuthorGetThemeVariantMessageHandler.AUTHOR_THEME_VARIANT_GET_ERROR;
import static com.smartsparrow.rtm.message.handler.courseware.theme.AuthorGetThemeVariantMessageHandler.AUTHOR_THEME_VARIANT_GET_OK;
...
public class AuthorGetThemeVariantMessageHandlerTest {
    private Session session;

    @InjectMocks
    AuthorGetThemeVariantMessageHandler handler;
    ...
    void setUp() {
        ...
        handler = new AuthorGetThemeVariantMessageHandler(themeService);
    }
    ...
    void handle() throws IOException {
        ...
        MessageHandlerTestUtils.verifySentMessage(session, response -> {
            assertAll(() -> {
                assertEquals(AUTHOR_THEME_VARIANT_GET_OK, response.getType());
    ...
    void handle_exception() throws IOException {
        ...
        MessageHandlerTestUtils.verifySentMessage(session,
                                                  "{\"type\":\"" + AUTHOR_THEME_VARIANT_GET_ERROR + "\",\"code\":422," +
