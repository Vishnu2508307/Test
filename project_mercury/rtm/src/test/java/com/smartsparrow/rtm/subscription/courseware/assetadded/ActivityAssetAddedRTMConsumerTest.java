...
class ActivityAssetAddedRTMConsumerTest {

    @InjectMocks
    private ActivityAssetAddedRTMConsumer assetAddedRTMConsumer;
    ...
    void setUp() {
        ...
        when(activityAssetAddedRTMConsumable.getContent()).thenReturn(message);
        when(activityAssetAddedRTMConsumable.getBroadcastType()).thenReturn(broadcastType);
        when(activityAssetAddedRTMConsumable.getSubscriptionId()).thenReturn(subscriptionId);
    ...
    void accept_filterOutSameClientProducer() {
        when(activityAssetAddedRTMConsumable.getRTMClientContext()).thenReturn(rtmClientContext);

        assetAddedRTMConsumer.accept(rtmClient, activityAssetAddedRTMConsumable);
    ...
    void accept_writesToWebSocket() {
        ...
        when(activityAssetAddedRTMConsumable.getRTMClientContext()).thenReturn(producer);
