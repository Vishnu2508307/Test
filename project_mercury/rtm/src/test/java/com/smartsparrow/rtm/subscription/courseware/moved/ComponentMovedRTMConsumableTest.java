...
class ComponentMovedRTMConsumableTest {
    ...
    void create() {
        ...
        ComponentMovedRTMConsumable consumable = new ComponentMovedRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new ComponentMovedRTMEvent().getName(), consumable.getRTMEvent().getName());
