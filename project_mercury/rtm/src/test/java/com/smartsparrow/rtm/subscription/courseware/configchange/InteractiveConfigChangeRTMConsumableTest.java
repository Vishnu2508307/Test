...
class InteractiveConfigChangeRTMConsumableTest {
    ...
    @Test
    void create() {
        ConfigChangeBroadcastMessage message = new ConfigChangeBroadcastMessage(activityId, interactiveId, INTERACTIVE, config);
        InteractiveConfigChangeRTMConsumable consumable = new InteractiveConfigChangeRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new InteractiveConfigChangeRTMEvent().getName(), consumable.getRTMEvent().getName());
