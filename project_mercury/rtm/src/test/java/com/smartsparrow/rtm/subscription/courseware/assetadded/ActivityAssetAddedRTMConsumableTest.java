...
class ActivityAssetAddedRTMConsumableTest {
    @Mock
    ...
    void create() {
        ...
        ActivityAssetAddedRTMConsumable consumable = new ActivityAssetAddedRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new ActivityAssetAddedRTMEvent().getName(), consumable.getRTMEvent().getName());
