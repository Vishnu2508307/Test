...
class FeedbackCreatedRTMConsumableTest {
    ...
    @Test
    void create() {
        FeedbackCreatedBroadcastMessage message = new FeedbackCreatedBroadcastMessage(activityId, feedbackId);
        FeedbackCreatedRTMConsumable consumable = new FeedbackCreatedRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new FeedbackCreatedRTMEvent().getName(), consumable.getRTMEvent().getName());
