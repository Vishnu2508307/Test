...
class AnnotationCreatedRTMConsumerTest {

    @InjectMocks
    private AnnotationCreatedRTMConsumer createdRTMConsumer;
    ...
    void setUp() {
        ...
        when(annotationCreatedRTMConsumable.getContent()).thenReturn(message);
        when(annotationCreatedRTMConsumable.getBroadcastType()).thenReturn(broadcastType);
        when(annotationCreatedRTMConsumable.getSubscriptionId()).thenReturn(subscriptionId);
    ...
    void accept_filterOutSameClientProducer() {
        when(annotationCreatedRTMConsumable.getRTMClientContext()).thenReturn(rtmClientContext);

        createdRTMConsumer.accept(rtmClient, annotationCreatedRTMConsumable);
    ...
    void accept_writesToWebSocket() {
        ...
        when(annotationCreatedRTMConsumable.getRTMClientContext()).thenReturn(producer);
        ...
        final String expected = "{" +
                ...
                "\"response\":{" +
                    ...
                    "\"rtmEvent\":\"ACTIVITY_ANNOTATION_CREATED\"," +
