...
public class CompetencyItemAssociationCreatedRTMConsumableTest {
    ...
    void create() {
        ...
        CompetencyItemAssociationCreatedRTMConsumable consumable = new CompetencyItemAssociationCreatedRTMConsumable(rtmClientContext, message);

        assertEquals(rtmClientContext, consumable.getRTMClientContext());
        assertEquals(new CompetencyItemAssociationCreatedRTMEvent().getName(), consumable.getRTMEvent().getName());
