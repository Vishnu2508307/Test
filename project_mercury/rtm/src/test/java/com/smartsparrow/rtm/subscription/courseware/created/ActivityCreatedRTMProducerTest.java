...
class ActivityCreatedRTMProducerTest {
    ...
    void buildConsumable() {
        activityCreatedRTMProducer.buildActivityCreatedRTMConsumable(rtmClientContext, rootElementId, activityId, parentPathwayId);
        assertNotNull(activityCreatedRTMProducer.getEventConsumable());
    }
