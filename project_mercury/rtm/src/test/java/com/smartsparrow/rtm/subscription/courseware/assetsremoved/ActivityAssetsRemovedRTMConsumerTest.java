...
class ActivityAssetsRemovedRTMConsumerTest {

    @InjectMocks
    private ActivityAssetsRemovedRTMConsumer assetsRemovedRTMConsumer;
    ...
    void setUp() {
        ...
        when(activityAssetsRemovedRTMConsumable.getContent()).thenReturn(message);
        when(activityAssetsRemovedRTMConsumable.getBroadcastType()).thenReturn(broadcastType);
        when(activityAssetsRemovedRTMConsumable.getSubscriptionId()).thenReturn(subscriptionId);
    ...
    void accept_filterOutSameClientProducer() {
        when(activityAssetsRemovedRTMConsumable.getRTMClientContext()).thenReturn(rtmClientContext);

        assetsRemovedRTMConsumer.accept(rtmClient, activityAssetsRemovedRTMConsumable);
    ...
    void accept_writesToWebSocket() {
        ...
        when(activityAssetsRemovedRTMConsumable.getRTMClientContext()).thenReturn(producer);
        ...
        final String expected = "{" +
                ...
                "\"rtmEvent\":\"ACTIVITY_ASSETS_REMOVED\"," +
