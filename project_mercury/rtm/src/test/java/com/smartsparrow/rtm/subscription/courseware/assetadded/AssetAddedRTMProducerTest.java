...
class AssetAddedRTMProducerTest {
    ...
    void buildConsumable() {
        assetAddedRTMProducer.buildAssetAddedRTMConsumable(rtmClientContext, activityId, interactiveId, INTERACTIVE);
        assertNotNull(assetAddedRTMProducer.getEventConsumable());
    }
