...
public class CsgDeleteNotificationHandler implements NotificationHandler {

    private static final Logger log = MercuryLoggerFactory.getLogger(CsgDeleteNotificationHandler.class);
