Feature: Create an ingestion
  ...
  Scenario: A user without owner permissions on the project cannot create an ingestion request
    ...
    When "Bob" tries creating an ingestion request in project "TRO" in workspace "one"
  ...
  Scenario: A user with project owner permissions on the project cannot create an ingestion request with a course name that exists
  ...
  Scenario: A user with project owner permissions on the activity can create an ingestion request
