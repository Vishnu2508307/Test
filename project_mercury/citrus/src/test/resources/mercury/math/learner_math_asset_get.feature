Feature: Fetch a learner math asset
  ...
  Scenario: It should allow a workspace role user to fetch a learner math asset
    ...
    When "Alice" fetches the learner math asset "MATH_ASSET_ONE"
    Then the learner math asset "MATH_ASSET_ONE" is successfully fetched
