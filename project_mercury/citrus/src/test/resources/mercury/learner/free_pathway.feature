Feature: Free pathway flow and functionality
  ...
  Background:
    ...
    And "Alice" has created a "SCREEN_ONE" interactive for the "FREE_ONE" pathway
    And "Alice" has created a "SCREEN_TWO" interactive for the "FREE_ONE" pathway
    And "Alice" has created a "SCREEN_THREE" interactive for the "FREE_ONE" pathway
