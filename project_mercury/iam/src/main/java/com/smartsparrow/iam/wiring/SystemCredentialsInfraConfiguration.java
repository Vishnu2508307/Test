...
public class SystemCredentialsInfraConfiguration extends StaticConfiguration<SystemCredentialsInfraResponse> {

    @Inject
    public SystemCredentialsInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
