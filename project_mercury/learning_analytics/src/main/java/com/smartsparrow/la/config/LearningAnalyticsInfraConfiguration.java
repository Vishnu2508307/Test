...
import com.smartsparrow.plugin.wiring.SchemaInfraResponse;

public class LearningAnalyticsInfraConfiguration extends StaticConfiguration<LearningAnalyticsInfraResponse> {

    @Inject
    public LearningAnalyticsInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
