...
class AssetSummaryMaterializer implements TableMaterializer {
    private final PreparedStatementCache preparedStatementCache;

    @Inject
    public AssetSummaryMaterializer(PreparedStatementCache preparedStatementCache) {
