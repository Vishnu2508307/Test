...
public class UserContentInfraConfiguration extends StaticConfiguration<UserContentInfraResponse> {

    @Inject
    public UserContentInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
