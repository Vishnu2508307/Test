...
public class GraphPathwayProgressByCoursewareMutator extends SimpleTableMutator<GraphPathwayProgress> {

    @Override
    public String getUpsertQuery(GraphPathwayProgress mutation) {
        return "INSERT INTO learner.progress_pathway_graph_by_courseware (" +
                " id" +
                ", deployment_id" +
                ", change_id" +
