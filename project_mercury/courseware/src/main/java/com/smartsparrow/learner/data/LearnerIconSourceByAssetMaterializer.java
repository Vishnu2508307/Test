...
public class LearnerIconSourceByAssetMaterializer implements TableMaterializer {

    private final PreparedStatementCache stmtCache;

    @Inject
    public LearnerIconSourceByAssetMaterializer(PreparedStatementCache stmtCache) {
    ...
    private static final String SELECT_BY_ID = "SELECT " +
            ...
            "width, " +
            "height " +
            "FROM learner.icon_source_by_asset " +
            "WHERE asset_id = ?";
