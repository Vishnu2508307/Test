...
public class LearnerCoursewareElementByDocumentItemMaterializer implements TableMaterializer {

    private final PreparedStatementCache stmtCache;

    @Inject
    public LearnerCoursewareElementByDocumentItemMaterializer(PreparedStatementCache stmtCache) {
        this.stmtCache = stmtCache;
    }

    public Statement fetch(UUID documentItemId, UUID deploymentId, UUID changeId) {
        String SELECT = "SELECT" +
                ...
                " document_id," +
                " element_type" +
                " FROM learner.courseware_element_by_document_item" +
        ...
        stmt.bind(documentItemId, deploymentId, changeId);
