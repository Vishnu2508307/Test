...
public class LearnerComponentMaterializer implements TableMaterializer {

    private final PreparedStatementCache stmtCache;

    @Inject
    public LearnerComponentMaterializer(PreparedStatementCache stmtCache) {
    ...
    public LearnerComponent fromRow(Row row) {
        return new LearnerComponent()
