...
class FreePathwayProgressByCoursewareMaterializer  implements TableMaterializer {
    ...
    private static final String QUERY = "SELECT "
            ...
            + ", child_completed"
            + " FROM learner.progress_pathway_free_by_courseware"
            + " WHERE deployment_id = ?"
    ...
    @Inject
    FreePathwayProgressByCoursewareMaterializer(PreparedStatementCache stmtCache) {
