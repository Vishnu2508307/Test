...
class GradePassbackNotificationMaterializer implements TableMaterializer {

    private final PreparedStatementCache stmtCache;

    @Inject
    public GradePassbackNotificationMaterializer(final PreparedStatementCache stmtCache) {
    ...
    public Statement findById(final UUID notificationId) {
        ...
        final String QUERY = "SELECT" +
                ...
                ", status" +
                ", completed_at" +
                "  FROM learner.grade_passback_notification" +
