...
public class GraphPathwayProgressMaterializer implements TableMaterializer {

    private final PreparedStatementCache stmtCache;

    @Inject
    public GraphPathwayProgressMaterializer(PreparedStatementCache stmtCache) {
    ...
    public Statement find(final UUID id) {
        ...
        final String QUERY = "SELECT "
                ...
                + " FROM learner.progress_pathway_graph"
                + " WHERE id = ?";
        // @formatter:on
    ...
    public GraphPathwayProgress fromRow(Row row) {
