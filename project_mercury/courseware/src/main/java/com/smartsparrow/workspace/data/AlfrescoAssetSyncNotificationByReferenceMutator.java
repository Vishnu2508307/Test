...
class AlfrescoAssetSyncNotificationByReferenceMutator extends SimpleTableMutator<AlfrescoAssetSyncNotification>  {

    @Override
    public Statement upsert(AlfrescoAssetSyncNotification mutation) {

        // @formatter:off
        String QUERY = "INSERT INTO asset.alfresco_sync_notification_by_reference (" +
                " reference_id" +
                ", notification_id" +
                ", course_id" +
                ", asset_id" +
