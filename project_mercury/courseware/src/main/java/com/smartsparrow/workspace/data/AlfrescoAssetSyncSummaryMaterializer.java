...
class AlfrescoAssetSyncSummaryMaterializer implements TableMaterializer {

    private final PreparedStatementCache stmtCache;

    @Inject
    public AlfrescoAssetSyncSummaryMaterializer(final PreparedStatementCache stmtCache) {
    ...
    public Statement findById(final UUID referenceId) {
        ...
        final String QUERY = "SELECT" +
                ...
                ", status" +
                ", completed_at" +
                "  FROM asset.alfresco_sync_summary" +
                "  WHERE reference_id = ?";
        // @formatter:on
