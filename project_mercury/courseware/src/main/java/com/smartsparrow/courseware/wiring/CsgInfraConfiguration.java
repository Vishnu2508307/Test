...
public class CsgInfraConfiguration extends StaticConfiguration<CsgInfraResponse> {

    @Inject
    public CsgInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
