...
public class CoursewareChangeLogProjectMutator extends SimpleTableMutator<ChangeLogByProject> {

    @Override
    public Statement upsert(ChangeLogByProject mutation) {
        // @formatter:off
        String QUERY = "INSERT INTO courseware.changelog_by_project (" +
                "  project_id" +
                ", id" +
                ", account_id" +
                ", courseware_action" +
    ...
    public void bindUpsert(BoundStatement stmt, ChangeLogByProject mutation) {
