...
public class SchemaInfraConfiguration extends StaticConfiguration<SchemaInfraResponse> {

    @Inject
    public SchemaInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
