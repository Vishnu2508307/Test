...
public class PluginLogInfraConfiguration extends StaticConfiguration<PluginLogInfraResponse> {

    @Inject
    public PluginLogInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
