...
public class PublicationInfraConfiguration extends StaticConfiguration<PublicationInfraResponse> {

    @Inject
    public PublicationInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
