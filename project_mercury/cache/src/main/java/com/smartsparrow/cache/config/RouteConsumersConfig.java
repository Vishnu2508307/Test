...
public class RouteConsumersConfig {
    ...
    public RouteConsumersConfig setLeanerEvaluateCompleteConsumers(Integer leanerEvaluateCompleteConsumers) {
    ...
    public RouteConsumersConfig setLearnerStudentScopeSetConsumers(Integer learnerStudentScopeSetConsumers) {
    ...
    public RouteConsumersConfig setLeanerProgressBroadcastConsumers(Integer leanerProgressBroadcastConsumers) {
    ...
    public RouteConsumersConfig setCompetencyDocumentUpdateConsumers(Integer competencyDocumentUpdateConsumers) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        RouteConsumersConfig that = (RouteConsumersConfig) o;
