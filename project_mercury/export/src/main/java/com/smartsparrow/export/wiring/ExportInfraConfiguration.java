...
public class ExportInfraConfiguration extends StaticConfiguration<ExportInfraResponse> {

    public ExportInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
