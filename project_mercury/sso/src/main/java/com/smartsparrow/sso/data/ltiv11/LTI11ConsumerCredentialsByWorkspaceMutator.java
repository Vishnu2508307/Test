...
class LTI11ConsumerCredentialsByWorkspaceMutator extends SimpleTableMutator<LTIv11ConsumerKey> {

    @Override
    public String getUpsertQuery(LTIv11ConsumerKey mutation) {
        return "INSERT INTO iam_global.lti11_consumer_credentials_by_workspace (" +
                " id" +
                ", oauth_consumer_key" +
