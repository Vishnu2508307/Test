...
public class IESInfraConfiguration extends StaticConfiguration<IESInfraResponse> {

    @Inject
    public IESInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
