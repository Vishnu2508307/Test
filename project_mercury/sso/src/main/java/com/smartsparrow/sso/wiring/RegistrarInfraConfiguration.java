...
public class RegistrarInfraConfiguration extends StaticConfiguration<RegistrarInfraResponse> {

    @Inject
    public RegistrarInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
