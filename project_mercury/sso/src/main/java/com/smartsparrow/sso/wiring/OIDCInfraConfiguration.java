...
public class OIDCInfraConfiguration extends StaticConfiguration<OIDCInfraResponse> {

    @Inject
    public OIDCInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
