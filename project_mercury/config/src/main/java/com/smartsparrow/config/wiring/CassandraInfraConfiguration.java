...
import com.smartsparrow.config.CassandraInfraResponse;
...
public class CassandraInfraConfiguration extends StaticConfiguration<CassandraInfraResponse> {

    @Inject
    public CassandraInfraConfiguration(final Map<String, Provider<ConfigurationLoadStrategy>> loadStrategyMapBinder,
